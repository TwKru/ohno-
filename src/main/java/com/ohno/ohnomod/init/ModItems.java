...
public class ModItems {
    ...
    public static final Item WOLFRAM_PLATE = new ItemBase("wolfram_plate");
    ...
    public static final Item WOLFRAM_DUST = new ItemBase("wolfram_dust");
    ...
    public static final Item WOLFRAM_INGOT = new ItemBase("wolfram_ingot");
